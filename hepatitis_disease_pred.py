...
#y = df['Class'].apply(lambda x: 1 if x > 0 else 0)  # Converting target to binary
y = df['Class']
...
model_filename = os.path.join(destination_folder, 'hepatitis_disease_model.pkl')

# Save the model to disk using pickle
model_filename = 'hepatitis_disease_model.pkl'
